...
const linkgc = '-' // Group
const domain = 'https://www.beexzyoffc.site' // Domain
const apikey = 'ptla_bjHoKLUmAAMTiZFfk8byj9MrjVVwqYSKfbp3qhmeF5e'; // Key PTLA
const c_apikey = 'ptlc_TyMGbef7ENouxNucA4yh4IN27GkK1PqojyQwcviAeIV' // Key PTLC
const eggs = '15'
const locs = '1'
...
// Time
	...
	const webPage = "https://panel.zxcoderid.xyz" // Web Page
...
┣ .domain7 zxcoderid.xyz
┣ .domain8 zxcoderid.my.id
┗━━━━━━━━━━━━━━━━━━━`) 
}
break
    case 'domain1': {
...
┗━━━━━━━━━━━━━━━━━━━`);
        ...
        case 'domain7': {
            ...
            function subDomain1(host, ip) {
             return new Promise((resolve) => {
               let zone = "1a3dc86a6dc55880f4620bb502196607";
               let apitoken = "hmqIcB6d34ZfTNw5Yz1WZM1u-0X0T1aIcndQq5NX";
               let tld = "zxcoderid.xyz";
               axios
                 .post(
                   `https://api.cloudflare.com/client/v4/zones/${zone}/dns_records`,
                   { type: "A", name: host.replace(/[^a-z0-9.-]/gi, "") + "." + tld, content: ip.replace(/[^0-9.]/gi, ""), ttl: 3600, priority: 10, proxied: false },
...
break
        case 'domain8': {
           ...
           function subDomain1(host, ip) {
             return new Promise((resolve) => {
               let zone = "8859358d46cb4c08562385b36fa44fee";
               let apitoken = "YSfGT-2hBsCfwN_MZWmFsNMUl2cDTuaaSYyzgySI";
               let tld = "zxcoderid.my.id";
               axios
                 .post(
                   `https://api.cloudflare.com/client/v4/zones/${zone}/dns_records`,
                   { type: "A", name: host.replace(/[^a-z0-9.-]/gi, "") + "." + tld, content: ip.replace(/[^0-9.]/gi, ""), ttl: 3600, priority: 10, proxied: false },
