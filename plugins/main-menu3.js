...
let dann = `Hai ${name}\n\n*AstroBotz-MD⚡* adalah bot Rpg PlayGround's yg membantu membuat sticker, dan membuat kalian bermain dengan senang-senang.\n\nBerikut ini list yang tersedia:\n\n• .allmenu [ Menampilkan Semua Perintah ]\n• .aimenu\n• .stickermenu\n\n2023 © MangFirman OFC\nBot masih dalam tahap Pengembangan.`
let menu = [
    '🗿'
    ]
