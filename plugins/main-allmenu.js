...
*AstroBot MD* adalah program bot whatsapp yang siap membantu anda dalam melakukan berbagai tindakan,mencari data atau informasi melalui whatsapp
...
ketik *.owner* untuk menyewa bot atau keperluan lainnya, Terima Kasih
─────────────
%readmore
Ⓛ = Limit / Diamonds
Ⓟ = Premium 
...
`.trimStart(),
  ...
  footer: '└───────────\n',
  after: `ꜱɪᴍᴘʟᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ ꜰɪʀᴍᴀɴ ᴏꜰᴄ
AstroBotz-MD⚡ : @WhatsApp
© 2023 - Frmnzz.Inc⚡
`,
}
...
// Fake Contact
 const fcon = {
    ...
    let thumb = 'https://telegra.ph/file/e5e053b3939d6c71557ec.jpg'
    let menu = [
    '🗿'
    ]
    ...
    //conn.sendButton(m.chat, text.trim(),"2023 © ZXcoderiD-MD", await (await fetch(thumb)).buffer(), [['Owner', '.owner'],['Donasi', '.donasi'],['Speed', '.speed']], true, { quoted: m })
    conn.sendMessage(m.chat, {
text: `${text}`,
contextInfo: {
externalAdReply: {
title: `${ucpn} 👋${name}`,
body: wm,
thumbnailUrl: 'https://telegra.ph/file/e5e053b3939d6c71557ec.jpg',
