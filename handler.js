                    ...
                    for (let user of participants) {
                        ...
                        try {
                          ...
                          /*  let wel = API('popcat', '/welcomecard', {
                            ...
                            */
                             let wel = `https://restapis.zxcoderid.xyz/api/canvas/welcome?nama=${name}&member=${member}&pp=https://telegra.ph/file/8814557e239fec1230787.jpg&apikey=Ichanzx`
                             let lea = `https://restapis.zxcoderid.xyz/api/canvas/goodbye?nama=${name}&member=${member}&pp=https://telegra.ph/file/8814557e239fec1230787.jpg&apikey=Ichanzx`
                             this.sendFile(id, action === 'add' ? wel : lea, 'pp.jpg', text, null, false, { mentions: [user] })
                          //  this.sendFile(id, wel, 'pp.jpg', text, null, false, { mentions: [user] })
                        }
                    }
                }
                break                          
